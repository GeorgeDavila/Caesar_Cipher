'''
This file is basically the raw gritty version of the program. 
Everything here should run and work well but its not pretty.
This version will run a bunch of test code. 
But its a project, not production code. So its good to see how the data structures work and play with them a bit.

But you can run it and type in your own string in console. Will then cipher it and save it alongside a label.
Remember this label! It is an encrption after all, you need the label to decipher your text.
Just input your 8-digit label in this function decipherfromfile(YOUR_LABEL_HERE) to decipher the text!
Cleaned up version coming soon! 
...
print('Your reference label is: ' + str(savedKey) + ' keep it, you need it to find your decryption key!')
